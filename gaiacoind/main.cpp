...
const string strMessageMagic = "GAIAcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GAIAcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // GAIA Genesis block
        // MainNet:
/*		genesis hash=000002288c192a41425fad133d6ea849ed444b6f57bf344461357781889dd009
		merkle root=39630336496caf9d3b936aa2fe0faa00d43cd5307e957206ce6337e77392cce7
		block.nTime = 1414527000
		block.nNonce = 1075277
*/
        // TestNet:
/*		genesis hash=00008677bd2e79e16386bd3415e6d771c8c6720cabcff0b16a50b7ef17d7c758
		merkle root=39630336496caf9d3b936aa2fe0faa00d43cd5307e957206ce6337e77392cce7
		block.nTime = 1414527000
		block.nNonce = 34015
*/
		
        const char* pszTimestamp = "Gaia was the Greek personification of the Earth";
        CTransaction txNew;
        txNew.nTime = 1414527000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
//				      prod : testnet
        block.nNonce   = !fTestNet ? 1075277 : 34015;

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x39630336496caf9d3b936aa2fe0faa00d43cd5307e957206ce6337e77392cce7"));
        block.print();
